        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Button
              variant="platinum"
              className="w-full h-12 text-base font-semibold rounded-xl"
              onClick={() => window.open('https://t.me/+erh8w1wS4pM0ZDdh?fbclid=PAZXh0bgNhZW0CMTEAAafIduGknhTZH-0hAVZlZ2xpIzHwNHRt0FUe9V_FVR8o3Mr66M0kkL84Ko2n6A_aem_3mzs9oLbzYlnZhsqmFJMYQ', '_blank', 'noopener,noreferrer')}
            >
              TELEGRAM
            </Button>
          </div>
          ...
          {/* Image Slideshow */}
          <div className="w-full h-[28rem] bg-white/5 rounded-lg overflow-hidden">
            <img
